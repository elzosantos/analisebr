...
<div class="col-md-12 hidden-print"> 
    ...
    <fieldset>
        <legend>Relátorios de desempenho individual</legend>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="textinput">Usuário <strong>*</strong></label>
            <div class="col-md-4">
                <?php
...
<?php if (!empty($result)) { ?>
    ...
    <div class="col-md-12">
        ...
        <legend>Relatório de busca (Relátorios de desempenho individual)</legend>

        <table class="table table-bordered">
            <tr>
                <td>
                    <strong>Usuário: </strong> <?php echo!empty($info['usuario']) ? $info['usuario'] : ''; ?> ( <?php echo!empty($info['username']) ? $info['username'] : ''; ?> )
                </td>
                <td>
                    <strong>Perfil: </strong>  <?php echo!empty($info['perfil']) ? $info['perfil'] : ''; ?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <strong>PF ajustado total + INM: </strong>  <?php echo  number_format(( $info['pf_total_ajustado'] + $info['pf_total_itens'] ), 2)    ; ?>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function pieChart() {
        ...
        $.each(json1, function (i, dadospfajus)
        {
            dataPfajus =
                    {
                        value: parseInt(dadospfajus.por_valor_fator),
                        color: cores[i],
                        title: dadospfajus.nome,
                        qtd: dadospfajus.pf_valor_fator_total
                    };
