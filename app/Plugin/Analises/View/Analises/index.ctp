<div class="well">Listagem das análises (PF)</div>
...
<div class="col-md-12">
    ...
    <div class="col-md-3" style="align-content: center">
        <label class="control-list">Tipo de Contagem</label>
        <?php
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('#IdEquipe').change(function(e){
            ...
            if(IdEquipe != '0'){
                $.getJSON('/analises/analises/carregaResponsavel/'+IdEquipe, function (dados){ 
            ...
            "aoColumns": [
                ...
                {"fnRender": function (oObj) {
                        return '<a href=/analises/analises/analises/' + oObj.aData[0] + '>' + '<img title=\'Editar\' src=\'/img/icons/edit.jpg\'>' + '</a> \n\
                                ...
                                <a onClick="duplicar(\'/analises/analises/duplicar/' + oObj.aData[0] + '\')" href=#><img width=\'16px\' height=\'16px\' title=\'Duplicar análise\' src=\'/img/icons/duplicar.jpg\'></a> \n\
