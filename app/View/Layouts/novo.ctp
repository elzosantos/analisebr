...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        echo $this->Html->script('excellentexport.min');
        echo $this->Html->script('Countable');
...
//       
    ...
    <body>
        <?php echo $this->element('header_novo'); ?>
                ...
                <div class="col-md-12">
                    <ul class="list-inline pull-right hidden-print">
                        ...
                        <?php if ($this->Session->read('Auth.User.role_id') == '1') { ?>
                            <li><a href="/painel/painel/logs"><span class="glyphicon glyphicon-cog"></span> Ferramentas</a></li>
                        <?php } ?>
                        <li><a href="/analises/analises/add"><span class="glyphicon glyphicon-plus-sign"></span> Adicionar Análise (PF)</a></li>
                        <li><a href="/analiusts/analiusts/add"><span class="glyphicon glyphicon-plus-sign"></span> Adicionar Análise (UST)</a></li>
                    </ul>
                    <strong class="hidden-print"><i class="glyphicon glyphicon-dashboard"></i>Sistema de Análise de Ponto de Função</strong>
                    <hr>
                    <div class="row">
